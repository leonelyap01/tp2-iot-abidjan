/*
 * ESP32 MQTT IoT Stack - Wokwi Simulator
 * Envoie des données de température et humidité vers Mosquitto
 * Format: InfluxDB Line Protocol
 *
 * CONFIGURATION REQUISE:
 * 1. Installez les bibliothèques dans Wokwi:
 *    - PubSubClient
 *    - DHT sensor library
 * 2. Remplacez VOTRE_IP_LOCALE par votre adresse IP (ipconfig)
 * 3. Créez un fichier diagram.json avec ESP32 + DHT22
 */
...
// ===== CONFIGURATION MQTT =====
// ⚠️ IMPORTANT: Remplacez par votre IP locale (trouvée avec ipconfig)
const char* mqtt_server = "10.0.27.187";  // Ex: "192.168.1.100"
...
const long publishInterval = 10000; // 10 secondes (correspond à telegraf interval)
